      ...
      <div id="profile" className='w-screen min-h-[95vh] lg:mt-12 lg:px-12 flex relative justify-center'>
        <div id="cartProducts" className='lg:flex flex-col p-0 w-[100vw] lg:w-[80vw] min-h-[60vh] m-0 lg:mt-0 bg-slate-100 mx-0 lg:mx-2 lg:rounded-lg lg:p-6 items-center overflow-x-hidden'>
          <div className="w-full flex items-center justify-center mb-10 mt-4">
            <h1 className=' text-4xl md:text-6xl font-normal text-red-500 underline'>Update Product</h1>
          </div>

          <form className="w-full mt-14 flex flex-col justify-center items-center gap-7 md:gap-10" onSubmit={updateProduct}>
            ...
            <div className="w-full px-4">
              ...
              <textarea id="message" rows="8" className="block p-2.5 w-full  text-base md:text-lg text-gray-900 bg-gray-200 rounded-lg border border-gray-300 focus:ring-red-500 focus:border-red-500 dark:focus:ring-red-500 dark:focus:border-red-500" placeholder="Leave a comment..." maxLength={500}  value={product.description} onChange={(e) => setProduct({...product, description: e.target.value})}  required ></textarea>
            </div>
            ...
            <div className="w-full my-10 flex items-center justify-center">
              <button  type="submit" className="text-white bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 font-medium rounded-lg py-2.5 text-center me-2 mb-2 w-fit px-6 text-xl">Update Product</button>
            </div>
          </form>
        </div>
      </div>
